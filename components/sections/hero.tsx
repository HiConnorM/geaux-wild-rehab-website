...
export function Hero() {
  ...
  return (
    <section className="relative min-h-screen bg-[#26C9AA] overflow-hidden">
      ...
      {/* Main content */}
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 pt-24 md:pt-28 lg:pt-36 pb-0">
        ...
        <div className={`flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 lg:gap-8 mb-6 md:mb-8 transition-all duration-700 delay-200 ${vis ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="max-w-md">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <Button asChild variant="outline" size="lg" className="rounded-full h-12 md:h-14 px-6 md:px-8 border-2 border-white text-white hover:bg-white hover:text-[#26C9AA] font-bold text-sm md:text-base w-full sm:w-auto justify-center">
                <Link href="/support">
        ...
        <div className="relative w-[85%] sm:w-[70%] md:w-[55%] lg:w-[45%] mx-auto">
          <div className="relative aspect-[3/4]">
            <Image 
              ...
              alt="Red Fox" 
              fill 
              className="object-contain object-bottom drop-shadow-2xl -mt-[19px]" 
              priority 
