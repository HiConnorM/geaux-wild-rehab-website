...
export function AboutSection() {
  ...
  return (
    <section ref={ref} className="relative z-10 bg-[#F8F4F4] overflow-hidden pt-16 pb-6 md:pt-20 md:pb-6 lg:pt-28" style={{ paddingTop: '-10px', paddingBottom: '25px' }}>
      ...
      {/* Wave at bottom — navy bites up, lives in z-10 About so it always shows */}
